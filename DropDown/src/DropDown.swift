...
extension DropDown {
    ...
    func height(str:String, withConstrainedWidth width: CGFloat, font: UIFont) -> CGFloat {
    ...
    fileprivate var tableHeight: CGFloat {
        // print("tableHeight \(tableView.rowHeight * CGFloat(dataSource.count))")
        var heightOfTableView: CGFloat = 0.0
        // Get visible cells and sum up their heights
        for index in 0 ..< self.dataSource.count {
            heightOfTableView += height(str: dataSource[index], withConstrainedWidth: self.tableView.frame.width - 16, font: textFont) + 17
        }
        
        // print("heightOfTableView \(heightOfTableView)")
        
        return heightOfTableView + 9
    }
